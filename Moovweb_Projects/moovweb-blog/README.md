...
Then in a web browser, you can visit [blog.moovdemos.com](http://blog.moovdemos.com) and you are ready to start testing and developing!
...
If running `sudo moov server`, remember to put all domains you're going to hit in your etc/hosts if you run your server with the `-auto-hosts=false` option.
    ...
    127.0.0.1   blog.moovdemos.com    127.0.0.1   moov-origin.blog.moovdemos.com
